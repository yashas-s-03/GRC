...
import { Shield, Zap, X, Mail, Lock, Globe2, History } from 'lucide-react'
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '64px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              {isDemo && (
                <span style={{ background: '#f59e0b20', border: '1px solid #f59e0b50', borderRadius: 9999, padding: '0.2rem 0.75rem', fontSize: '0.72rem', fontWeight: 700, color: '#f59e0b', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Demo Mode</span>
              )}
              <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}>
                <button style={linkStyle} onClick={() => scrollToSection('how-it-works')} onMouseEnter={e => e.currentTarget.style.color = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>How it Works</button>
                <button style={linkStyle} onClick={() => scrollToSection('pricing')} onMouseEnter={e => e.currentTarget.style.color = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Pricing</button>
                <button style={linkStyle} onClick={() => navigate('/compare')} onMouseEnter={e => e.currentTarget.style.color = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Compare</button>
                <button style={linkStyle} onClick={() => navigate('/history')} onMouseEnter={e => e.currentTarget.style.color = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}><History size={14} />History</span>
                </button>
                <button style={linkStyle} onClick={() => setShowSignIn(true)} onMouseEnter={e => e.currentTarget.style.color = '#f8fafc'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Sign In</button>
              </div>
              <button className="btn-primary"
                style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.875rem', padding: '0.5rem 1.25rem' }}
                onClick={() => navigate(isDemo ? '/scan?demo=true' : '/scan')}
              >
